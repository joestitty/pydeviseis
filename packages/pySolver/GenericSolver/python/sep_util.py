...
try:
    ...
    import GenericSolver.python.sys_util as sys_util
...
# Checking local directory
    ...
    out = (sys_util.RunShellCmd("cat .datapath | head -n 1", check_code=False, get_stat=False)[0]).rstrip()
